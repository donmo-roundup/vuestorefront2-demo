...
export default {
  ...
  "It was not possible to request a new password, please check the entered email address.":
    "Es war nicht möglich, ein neues Passwort anzufordern, bitte überprüfen Sie die eingegebene E-Mail-Adresse.",
  Item: "Artikel",
  Items: "Gegenstände",
  ...
  "Manage addresses":
    "Verwalten Sie alle gewünschten Adressen (Arbeitsplatz, Privatadresse...) Auf diese Weise müssen Sie die Adresse nicht bei jeder Bestellung manuell eingeben.",
  ...
  "The account sign-in was incorrect or your account is disabled temporarily. Please wait and try again later.":
    "Die Kontoanmeldung war falsch oder Ihr Konto wurde vorübergehend deaktiviert. Bitte warten Sie und versuchen Sie es später erneut.",
  "A customer with the same email address already exists in an associated website.":
    "Ein Kunde mit derselben E-Mail-Adresse existiert bereits auf einer verknüpften Website.",
  ...
  "Find stunning women's cocktail dresses and party dresses. Stand out in lace and metallic cocktail dresses from all your favorite brands.":
    "Finden Sie atemberaubende Cocktailkleider für Damen und Cocktailkleider für Party-D…c von all Ihren Lieblingsmarken.",
  ...
  "There was some error while trying to fetch shipping methods. We are sorry, please try with different shipping details.":
    "Beim Versuch, Versandarten abzurufen, ist ein Fehler aufgetreten. Es tut uns leid, bitte versuchen Sie es mit anderen Versanddetails oder später.",
  "There was some error while trying to select this shipping method. We are sorry, please try with different shipping method.":
    "Beim Versuch, diese Versandart auszuwählen, ist ein Fehler aufgetreten. Es tut uns leid, bitte versuchen Sie es mit einer anderen Versandart.",
  ...
  "The coupon code isn't valid. Verify the code and try again.":
    "Der Gutscheincode ist ungültig. Überprüfen Sie den Code und versuchen Sie es erneut.",
  From: "Aus",
  To: "Zu",
  ...
  "The password must be at least 8 characters long and must contain at least: 1 uppercase or lowercase letter, 1 number, or one special character (E.g. , . _ & ? etc)":
    "Das Passwort muss mindestens 8 Zeichen lang sein und muss mindestens enthalten: 1 Groß- oder Kleinbuchstabe, 1 Ziffer oder ein Sonderzeichen (z. B. , . _ & ? usw.)",
  ...
  "You must confirm your account. Please check your email for the confirmation link.":
    "Sie müssen Ihr Konto bestätigen. Bitte überprüfen Sie Ihre E-Mail auf den Bestätigungslink.",
  ...
  "Donmo Donation": "Spende für die Ukraine",
};
